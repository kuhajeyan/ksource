...
function checkConfigForSave()
{
  ...
  {
    alert("$Encoder.bodyJavascriptEscape($ResourceBundle.getString('ConfRepositoryConnector.ConfSOAPPathMustNotBeNull'))");
    SelectTab("$Encoder.bodyJavascriptEscape($ResourceBundle.getString('ConfRepositoryConnector.Server'))");
    editconnection.confpath.focus();
    return false;
  }
  ...
  if (editconnection.confsoapapipath.value != "" && !(editconnection.confsoapapipath.value.indexOf("/") == 0))
  {
    alert("$Encoder.bodyJavascriptEscape($ResourceBundle.getString('ConfRepositoryConnector.ConfSOAPPathMustBeginWithASlash'))");
    SelectTab("$Encoder.bodyJavascriptEscape($ResourceBundle.getString('ConfRepositoryConnector.Server'))");
    editconnection.confpath.focus();
    return false;
  }
